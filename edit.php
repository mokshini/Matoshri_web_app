...
{
	mysqli_query($con,"UPDATE notices SET title='$title', notice='$notice', date='$date', access='$access' WHERE id='$edit'");
...
<?php
$a=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM notices WHERE id='$edit'"));
?>
