...
{
	// header("location:adm-notice.php");
}
...
else
{
	...
	mysqli_query($con,"INSERT INTO notices(title,notice,file,date,access) VALUES('$title','$notice','$filename','$date','$access')");
...
{
	mysqli_query($con,"DELETE FROM notices WHERE id='$del'");
}
...
<body>
<span class="head">Matoshri Notice Board Control</span>
...
<a href="adm-notice.php?del=<?php echo $b['id'];?>" onclick="return confirm('Are You Sure..?');" style="text-shadow:0px 0px 1px #000000;">Delete</a>
</td></tr>
<?php } ?>
</table>
